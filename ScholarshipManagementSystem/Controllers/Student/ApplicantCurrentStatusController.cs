...
namespace ScholarshipManagementSystem.Controllers.Student
{
    public class ApplicantCurrentStatusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ApplicantCurrentStatusId,Value,IsActive")] ApplicantCurrentStatus applicantCurrentStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ApplicantCurrentStatusId,Value,IsActive")] ApplicantCurrentStatus applicantCurrentStatus)
        {

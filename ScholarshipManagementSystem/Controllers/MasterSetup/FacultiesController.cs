...
namespace ScholarshipManagementSystem.Controllers.MasterSetup
{
    public class FacultiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FacultyId,Name,Code,Description")] Faculty faculty)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FacultyId,Name,Code,Description")] Faculty faculty)
        {
